...
sys.path.insert(0, str(REPO_ROOT / "human" / "kinematics"))
from dong_kinematics import DongKinematics, _block_1_world_to_wrist_local

RAW_CSV = REPO_ROOT / "human" / "datasets" / "hograspnet" / "raw" / "hograspnet_raw.csv"
OUT_CSV = REPO_ROOT / "human" / "datasets" / "hograspnet" / "processed" / "hograspnet_abl11.csv"
