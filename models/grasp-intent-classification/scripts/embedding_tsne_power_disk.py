...
Usage (from repo root, with .venv active):
    python models/grasp-intent-classification/scripts/embedding_tsne_power_disk.py

Output:
    models/grasp-intent-classification/experiments/run_abl04/embedding_tsne_power_disk.png
"""
...
sys.path.insert(0, str(ROOT / "packages" / "grasp-gcn" / "src"))
...
MODEL_PATH  = ROOT / "apps/graphgrasp-live/models/best_model_run_abl04_xyz_ahg_flex.pth"
CSV_PATH    = ROOT / "models/grasp-intent-classification/data/raw/hograspnet.csv"
OUT_PATH    = ROOT / "models/grasp-intent-classification/experiments/run_abl04/embedding_tsne_power_disk.png"
