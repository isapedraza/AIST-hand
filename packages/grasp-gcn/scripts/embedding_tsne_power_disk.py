...
Usage (from repo root, with .venv active):
    python packages/grasp-gcn/scripts/embedding_tsne_power_disk.py

Output:
    packages/grasp-gcn/experiments/run_abl04/embedding_tsne_power_disk.png
"""
...
CSV_PATH    = ROOT / "packages/grasp-gcn/data/raw/hograspnet.csv"
OUT_PATH    = ROOT / "packages/grasp-gcn/experiments/run_abl04/embedding_tsne_power_disk.png"
