...
def _parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--lam_tip_pos",   type=float, default=1.0,  help="Weight for dense finger_pose extension of L_fingertip_pos, non-thumb fingers.")
    p.add_argument("--lam_thumb_pos", type=float, default=10.0, help="Weight for dense thumb_pose extension of L_thumb_pos. Separate from lam_tip_pos per paper.")
    ...
    p.add_argument("--lam_pip_pos",   type=float, default=0.0,  help="Optional extra PIP position term. Run31 defaults to 0 because dense finger_pose already includes PIP.")
