...
def parse_args():
    ...
    p.add_argument("--csv",       default="packages/cross-emb/data/processed/hograspnet_retarget.csv")
    ...
    p.add_argument("--ckpt_dir",  default="packages/cross-emb/checkpoints/retarget")
