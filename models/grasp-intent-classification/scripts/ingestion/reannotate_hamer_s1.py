...
CSV_IN      = Path("/home/yareeez/AIST-hand/models/grasp-intent-classification/data/raw/hograspnet_mano.csv")
CSV_OUT     = Path("/home/yareeez/AIST-hand/models/grasp-intent-classification/data/raw/hograspnet_hamer_s1.csv")
LOG_FAILED  = Path("/home/yareeez/AIST-hand/models/grasp-intent-classification/data/raw/hograspnet_hamer_s1_failed.txt")
