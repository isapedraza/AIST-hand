...
Usage:
    python precompute_hagrid_dong.py \
        ...
        --output /home/yareeez/AIST-hand/models/latent-retargeting/data/processed/hagrid_dong.csv
"""
...
def main():
    ...
    parser.add_argument("--output", default="/home/yareeez/AIST-hand/models/latent-retargeting/data/processed/hagrid_dong.csv")
