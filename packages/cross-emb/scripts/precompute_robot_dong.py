...
Usage:
    python packages/grasp-gcn/scripts/precompute_robot_dong.py \
        --input  packages/grasp-gcn/data/processed/valid_robot_poses_eigengrasp.npz \
        --urdf   /home/yareeez/dex-urdf/robots/hands/shadow_hand/shadow_hand_right.urdf \
        --hand_config packages/grasp-gcn/data/hand_configs/shadow_hand_right.yaml \
        --batch_size 20000
