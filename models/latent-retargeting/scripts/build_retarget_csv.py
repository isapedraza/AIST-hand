...
DATA_ROOT = REPO_ROOT / "human" / "datasets" / "hograspnet"
DONG_CSV = DATA_ROOT / "processed" / "hograspnet_dong.csv"
RAW_CSV  = DATA_ROOT / "raw"       / "hograspnet_raw.csv"
OUT_CSV  = DATA_ROOT / "processed" / "hograspnet_retarget.csv"
