...
def parse_args():
    ...
    p.add_argument("--csv",       default="models/latent-retargeting/data/processed/hograspnet_retarget.csv")
    ...
    p.add_argument("--ckpt_dir",  default="models/latent-retargeting/checkpoints/retarget")
