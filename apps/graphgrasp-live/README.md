...
Live GraphGrasp app. This app now lives at apps/graphgrasp-live and consumes the installed grasp_gcn package. Historical notes below may still mention the old grasp-app path.
