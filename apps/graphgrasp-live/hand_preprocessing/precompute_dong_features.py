...
def main():
    raw_csv_path = "/home/yareeez/AIST-hand/packages/grasp-gcn/data/raw/hograspnet_raw.csv"
    out_csv_path = "/home/yareeez/AIST-hand/packages/grasp-gcn/data/processed/hograspnet_dong.csv"
