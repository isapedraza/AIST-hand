"""
Generates the PyG cache for Run 010 (bone + velocity + mano_pose) locally.
Run from grasp-model/ with the venv activated:

    python scripts/build_cache_run010.py

Output: data/processed/hograspnet_{train,val,test}_c28_cmc_bone_vel_pose.pt
