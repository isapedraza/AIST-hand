...
Usage:
    python precompute_hagrid_dong.py \
        ...
        --output /home/yareeez/AIST-hand/packages/cross-emb/data/processed/hagrid_dong.csv
"""
...
sys.path.insert(0, str(Path(__file__).resolve().parents[3] / "apps" / "graphgrasp-live" / "hand_preprocessing"))
...
def main():
    ...
    parser.add_argument("--output", default="/home/yareeez/AIST-hand/packages/cross-emb/data/processed/hagrid_dong.csv")
