...
DEFAULT_OUT = Path(
    "packages/grasp-gcn/data/processed/"
...
DEFAULT_SYNTHETIC_QPOS_NPZ = (
    Path("packages/grasp-gcn/data/processed/synthetic_open_hand_shadow_qpos.npz"),
    Path("packages/grasp-gcn/data/processed/synthetic_close_hand_shadow_qpos.npz"),
)
